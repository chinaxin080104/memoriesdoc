...
func main() {
	...
	fmt.Println(sql) // select id,name,age from userinfos where id = 1
	//执行后输出
	//select name,age from students where name = '枫枫' and age = 23 <nil>
	//select id,name,age from userinfos where id = 1 <nil>
}
